                    ...
                    <div className="flex flex-col md:grid md:grid-cols-12 gap-4 items-start">
                      ...
                      <div className="md:col-span-6 flex items-start space-x-4 w-full">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-ivoryWhite mt-1">
                      ...
                      <div className="md:col-span-3 w-full md:w-auto">
                        <div className="flex items-center gap-2 justify-between md:justify-center">
                          <Button
                            size="icon"
                            className="h-8 w-8 md:h-10 md:w-10 text-ivoryWhite bg-deepGraphite border border-[#B87333]/30 hover:border-[#B87333]"
                            onClick={() =>
                          ...
                          <Button
                            size="icon"
                            className="h-8 w-8 md:h-10 md:w-10 bg-deepGraphite text-ivoryWhite border border-[#B87333]/30 hover:border-[#B87333]"
                            onClick={() =>
                              handleQuantityChange(item.id, item.quantity + 1)
                            }
                          >
