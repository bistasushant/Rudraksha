          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="relative" ref={miniCartRef}>
                ...
                {miniCartOpen && (
                  <div
                    className="absolute right-0 mt-2 w-80 bg-gradient-to-br from-[#1C1C1C] via-gray-900 to-[#1C1C1C] border border-[#D4AF37] rounded-lg shadow-xl z-50 motion-safe:animate-fadeIn motion-safe:animate-slideDown motion-reduce:animate-none origin-top-right"
                    aria-modal="true"
                    aria-label="Mini Cart Preview"
                  >
                    <div className="p-4 text-lg font-semibold text-ivoryWhite border-b border-gray-600 flex justify-between items-center">
                      <span>Your Cart</span>
                      <button
                      ...
                      >
                        <svg
                          className="w-5 h-5 text-ivoryWhite"
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        >
                      ...
                      {cartItems.length > 0 ? (
                        <ul className="space-y-2">
                          {cartItems.map((item) => (
                            <li
                              key={item.id}
                              className="flex justify-between items-center text-sm text-ivoryWhite motion-safe:transition-opacity"
                            >
                        ...
                        <p className="text-base text-ivoryWhite text-center py-4">
                          Your cart is empty
                        </p>
                      )}
                    </div>
                    <div className="p-4 border-t border-gray-600">
                      <Link
                        href="/cart"
                        onClick={() => setMiniCartOpen(false)}
                        className="block text-center w-full px-4 py-2 bg-gradient-to-r from-[#8B1A1A] to-[#D4AF37] text-white rounded-lg motion-safe:transition-all duration-200 text-base focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-500 focus-visible:ring-offset-2 focus-visible:ring-offset-gray-900"
                      >
                        View Cart
                      </Link>
                    </div>
              ...
              <div className="relative" ref={dropdownRef}>
                ...
                {isDropdownOpen && (
                  <div
                    className="absolute right-0 mt-2 w-56 bg-gradient-to-br from-[#1C1C1C] via-gray-900 to-[#1C1C1C] border border-[#D4AF37] rounded-lg shadow-xl z-50 motion-safe:animate-fadeIn motion-safe:animate-slideDown motion-reduce:animate-none origin-top-right overflow-hidden"
                    aria-orientation="vertical"
                      ...
                      >
                        ...
                        <div className="space-y-2">
                          {[
                            ...
                            { label: "Order History", href: "/dashboard?tab=orders", icon: "📦" },
                            { label: "Wishlist", href: "/dashboard?tab=wishlist", icon: "❤️" },
                            { label: "My Profile", href: "/dashboard?tab=profile", icon: "👤" },
                            { label: "Change Password", href: "/dashboard?tab=password", icon: "🔐" }
                          ].map((item) => (
                            <Link
                              key={item.label}
                              href={item.href}
