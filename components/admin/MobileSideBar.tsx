      ...
      >
        ...
        <nav className="grid gap-1 p-4 -mt-16">
          <Link
            ...
            className={`flex items-center gap-3 rounded-lg px-3 py-2 text-white/70 transition-all hover:text-purple-400 ${pathname === "/admin/dashboard" ? "border border-purple-500" : ""
              }`}
          >
          ...
          <Link
            ...
            className={`flex items-center gap-3 rounded-lg px-3 py-2 text-white/70 transition-all hover:text-purple-400 ${pathname === "/admin/dashboard/orders"
          ...
          <Link
            ...
            className={`flex items-center gap-3 rounded-lg px-3 py-2 text-white/70 transition-all hover:text-purple-400 ${pathname === "/admin/dashboard/customers"
              ? "border border-purple-500"
              : ""
              }`}
          >
          ...
          <Link
            ...
            className={`flex items-center gap-3 rounded-lg px-3 py-2 text-white/70 transition-all hover:text-purple-400 ${pathname === "/admin/dashboard/payments"
              ? "border border-purple-500"
              : ""
              }`}
          >
          ...
          <Link
            ...
            className={`flex items-center gap-3 rounded-lg px-3 py-2 text-white/70 transition-all hover:text-purple-400 ${pathname === "/admin/dashboard/shipping"
              ? "border border-purple-500"
              : ""
              }`}
          >
          ...
          <Link
            ...
            className={`flex items-center gap-3 rounded-lg px-3 py-2 text-white/70 transition-all hover:text-purple-400 ${pathname === "/admin/dashboard/testimonial"
              ? "border border-purple-500"
              : ""
              }`}
          >
          ...
          {admin?.role === "admin" && (
            <>
              <Link
                ...
                className={`flex items-center gap-3 rounded-lg px-3 py-2 text-white/70 transition-all hover:text-purple-400 ${pathname === "/admin/dashboard/user"
                  ? "border border-purple-500"
                  : ""
                  }`}
              >
